...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            _x = self
            buff.write(_get_struct_8B().pack(_x.gACT, _x.gGTO,
                       _x.gSTA, _x.gOBJ, _x.gFLT, _x.gPR, _x.gPO, _x.gCU))
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (_x.gACT, _x.gGTO, _x.gSTA, _x.gOBJ, _x.gFLT, _x.gPR,
             _x.gPO, _x.gCU,) = _get_struct_8B().unpack(str[start:end])
            return self
